...
{{--                {{adminNav($thisAction)}}--}}
        ...
        <form class="layui-form" action=""  method="post" id="addGate">
            ...
            <input type="hidden" class="gate_id" name="gate_id" value="{{$gate_id}}">
            <div class="layui-row">
            ...
            <div class="layui-row">
                ...
                <div class="layui-inline" style="padding-left: 20%;">
                    ...
                    <a  href="{{adminurl("/subject/showsubject/$gate_id")}}"><button type="button" class="layui-btn layui-btn-warm log-action reset" data-method="reFormAdd">
                            取消</button></a>
                </div>
...
@section("javascript")
    ...
    <script src="{{asseturl("js/subject/add.js")}}"></script>
@stop
