...
<meta name="csrf-token" content="{{ csrf_token() }}">
    <div class="layui-body">
        ...
        <div id="mainbox" class="layui-row">
            ...
            <form class="layui-form" action=""  method="post" id="formEditcontent">
                ...
                <div class="layui-col-md12">
                    <div class="layui-col-md6">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block" style="margin-left: 130px;">
                                    <textarea id="article" type="text" name="article"  lay-verify="required" autocomplete="off" class="layui-input" value="" style="min-height: 200px;padding: 10px;" >{{$result->article}} </textarea>
                                </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-inline" style="padding-left: 20%;">
                    <button class="layui-btn layui-btn-normal" lay-submit lay-filter="formEditcontent">确定</button>
