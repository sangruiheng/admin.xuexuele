    ...
    <div class="layui-body">
        ...
        <div id="mainbox" class="layui-row">
            ...
            <blockquote class="site-text layui-elem-quote">
             ...
             <form class="layui-form" action=""  method="post" id="formAddvoice">
                ...
                <input  type="hidden" name="voice"  autocomplete="off" class="layui-input" id="videourl" >
                ...
                <div class="layui-col-md12">
                    <div class="layui-col-md6">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-upload videoupload" style="margin-top: 10px;">
                ...
                <div class="layui-inline" style="padding-left: 20%;">
                    <button class="layui-btn layui-btn-normal" lay-submit lay-filter="formAddvoice">确定</button>
