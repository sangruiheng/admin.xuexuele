                        ...
                        <div class="layui-col-md6 layui-col-space5">
                            ...
                            @else
                                <div class="layui-form-item">
                                    <label class="layui-form-label">用户账号</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="username" required  lay-verify="required" placeholder="请输入用户账号" autocomplete="off" class="layui-input" value="@if(isset($adminInfo->username)){{$adminInfo->username}}@endif" readonly>
                                    </div>
                                </div>
                            @endif
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <select name="role_id" lay-verify="required" @if((isset($adminInfo->id) && $adminInfo->id==1) || $adminInfo->id != 1) disabled @endif>
                            ...
                            <div class="layui-form-item up-avator-box">
                                {{--<div class="layui-upload">--}}
                                    {{--<div class="layui-upload-list up-avator-show">--}}
                                        {{--<input type="hidden" id="putavator" name="avator" value="@if(isset($adminInfo->avator)){{$adminInfo->avator}}@endif">--}}
