            ...
            <div class="layui-form">
                <div style="display: flex;justify-content: flex-start;margin-bottom: 20px;">
                    <div style="background-color: #f8f8f9;margin-left: 30px;padding: 40px;" >
                        <p>课程查看量：<span>{{$data->studycount}}</span></p>
                    </div>
                    <div style="background-color: #f8f8f9;margin-left: 30px;padding: 40px;">
                        <p>智慧豆：<span>{{$data->wisdombeancount}}</span></p>
                    </div>
                    <div style="background-color: #f8f8f9;margin-left: 30px;padding: 40px;">
                        <p>智慧豆打赏：<span>{{$data->rewardplatformcount}}</span></p>
                    </div>
                </div>
            </div>
...
@stop
@section("javascript")
    <script src="{{asseturl("js/subscribe/subscribe.js")}}"></script>
