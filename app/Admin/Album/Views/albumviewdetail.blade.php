                    ...
                    <div class="layui-col-md6">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="albumname"  lay-verify="required" placeholder="" autocomplete="off" class="layui-input" value="{{$result->albumname}}" id="user_phone_up">
                            </div>
                        </div>
                    </div>
                </div>
                <input  type="hidden" name="albumimg"  autocomplete="off" class="layui-input" id="pictureurl" value="{{$result->albumimg}}">
                <div class="layui-col-md12">
                    <div class="layui-col-md6">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-upload pictureupload" style="margin-top: 10px;">
                                    ...
                                    <div class="layui-upload-list">
                                        <img src="{{$result->albumimg}}" class="layui-upload-img" id="demo1" style="width: 200px;">
                                        <p id="demoText"></p>
                                  </div>
                                </div>
                            </div>
                ...
                <div class="layui-col-md12">
                    <div class="layui-col-md6">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="albumcontent"  lay-verify="required" placeholder="" autocomplete="off" class="layui-input" value="{{$result->albumcontent}}" id="user_phone_up">
                            </div>
                        </div>
                    </div>
                </div>
