layui.use(['element', 'jquery', 'layer', 'form', 'laypage', 'laydate','upload'], function () {
    ...
    //文章
    form.on('submit(formEditcontent)', function (data) {
        $.ajax({
            url: adminurl + "/rewardcontent/updatecontent",
            data: $("#formEditcontent").serialize(),
            type: "post",
            dataType: "json",
            headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    //音频
    form.on('submit(formEditvoice)', function (data) {
        $.ajax({
            url: adminurl + "/rewardcontent/updatevoice",
            data: $("#formEditvoice").serialize(),
            type: "post",
            dataType: "json",
            headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
