layui.use(['element', 'jquery', 'layer', 'form', 'laypage', 'laydate'], function () {
    ...
    function floatDataTpl(data, page) {
        layui.each(data, function (index, item) {
            ...
            innerData += '<td>';
            innerData += '<a  href= "' + adminurl + '/gatealert/editgatealert/' + item.id + '" class="layui-btn layui-btn-sm layui-btn handle" data-id="' + item.id + '" data-state="2"><i class="layui-icon"></i>修改</a>';
