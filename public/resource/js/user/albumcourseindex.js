layui.use(['element', 'jquery', 'layer', 'form', 'laypage', 'laydate'], function () {
    ...
    var active = {
        delete: function () {
            ...
            layer.confirm(auditMsg, {
                ...
                $.ajax({
                    url: adminurl + "/users/coursedelete",
                    data: {
                        id: id,
                        status:state,
                        _token: _token,
    ...
    function getDataLists(page) {
        $.ajax({
            url: adminurl + "/users/albumcourselists/"+_id,
            data: {
                page:page,
    ...
    function floatDataTpl(data, page) {
        layui.each(data, function (index, item) {
            ...
            innerData += '<a  href= "' + adminurl + '/users/albumcourseviewdetail/' + item.id + '" class="layui-btn layui-btn-sm layui-btn handle" data-id="' + item.id + '" data-state="2"><i class="layui-icon"></i>查看</a>';
            //}
