            ...
            <blockquote class="site-text layui-elem-quote searchBox">
                <div style="display: flex;">
                    ...
                    <div class="layui-inline" style="margin-left: 20px;">
                        <a href="<?php echo e(adminurl("/rewardcontent/addcontentview")); ?>" class="layui-btn layui-btn-normal" target="_blank"><i class="layui-icon">&#xe608;</i>新建文章奖励</a> 
                    </div>
                    <div class="layui-inline" style="margin-left: 20px;">
                        <a href="<?php echo e(adminurl("/rewardcontent/addvoiceview")); ?>" class="layui-btn layui-btn-normal" target="_blank"><i class="layui-icon">&#xe608;</i>新建音频奖励</a> 
                    </div>
                </div>
            </blockquote>
...
<?php $__env->startSection("javascript"); ?>
    <script src="<?php echo e(asseturl("js/rewardcontent/index.js")); ?>"></script> 
