            ...
            <blockquote class="site-text layui-elem-quote searchBox">
                <div style="display: flex;">
                    ...
                    <div class="layui-inline" style="margin-left: 10px;">
                        <a href="<?php echo e(adminurl("/gatealert/addgatealert")); ?>" class="layui-btn layui-btn-normal" target="_blank"><i class="layui-icon">&#xe608;</i>新增弹窗内容</a>
                    </div>
                </div>
            </blockquote>
...
<?php $__env->startSection("javascript"); ?>
    <script src="<?php echo e(asseturl("js/gatealert/index.js")); ?>"></script>
<?php $__env->stopSection(); ?>
