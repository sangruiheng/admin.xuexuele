                ...
                <div class="layui-col-md12">
                    <div class="layui-col-md6">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input id="url" type="text" name="url"  lay-verify="required" autocomplete="off" class="layui-input" value=""  >
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block" >
                                <div class="layui-upload pictureupload" style="margin-top: 10px;">
                                    ...
                                    <span style="color: red"><b>100*100</b></span>
...
<?php $__env->startSection("javascript"); ?>
    <script src="<?php echo e(asseturl("js/gatealert/add.js")); ?>"></script>
<?php $__env->stopSection(); ?>
