...
<head>
    ...
    <link href="<?php echo e(asseturl("css/style.css")); ?>" type="text/css" rel="stylesheet">
    <style>
        body{color:#fff; font-family:"微软雅黑"; font-size:14px;background: url(<?php echo e(asseturl("images/bg3.jpg")); ?>) no-repeat center center fixed;
...
<script src="<?php echo e(asseturl("js/manage/login.js")); ?>"></script>
</body>
</html>
