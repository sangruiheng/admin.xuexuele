                        ...
                        <div class="layui-col-md6 layui-col-space5">
                            ...
                            <?php else: ?>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">管理员账号</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="username" required  lay-verify="required" placeholder="请输入用户账号" autocomplete="off" class="layui-input" value="<?php if(isset($adminInfo->username)): ?><?php echo e($adminInfo->username); ?><?php endif; ?>" readonly>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item up-avator-box">
                                <div class="layui-upload">
                                    <div class="layui-upload-list up-avator-show">
                                        <input type="hidden" id="putavator" name="avator" value="<?php if(isset($adminInfo->avator)): ?><?php echo e($adminInfo->avator); ?><?php endif; ?>">
                                        <img id="avator" class="layui-upload-img" src="<?php echo e($adminInfo->avator_url); ?>">
                                        <p id="demoText"></p>
                                    </div>
