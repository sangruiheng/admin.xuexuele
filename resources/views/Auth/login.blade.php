...
<head>
    ...
    <style>
        ...
        .main_content{background:url({{asseturl("/images/main_bg.png")}}) repeat; margin-left:auto; margin-right:auto; text-align:left; float:none; border-radius:8px;}
...
<body style="background:url({{asseturl("images/bg.jpg")}}) no-repeat;">
...
<script src="{{asseturl("js/Auth/login.js")}}"></script>
</body>
</html>
