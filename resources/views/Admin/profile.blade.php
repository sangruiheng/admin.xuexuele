            ...
            <div class="layui-col-md6">
                <form class="layui-form" action="">
                        ...
                        <div class="layui-form-item up-avator-box">
                            <div class="layui-upload">
                                <div class="layui-upload-list up-avator-show">
                                    ...
                                    <img id="avator" class="layui-upload-img" src="@if(isset($adminInfo->avator)) {{url("storage/".$adminInfo->avator)}}@else {{url("admins/images/default.png")}} @endif">
                                    <p id="demoText"></p>
                                </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="checkbox" name="state" lay-skin="switch" lay-text="是|否" @if(isset($adminInfo->state) && $adminInfo->state==1) checked @endif value="1">
                        </div>
                    </div>
